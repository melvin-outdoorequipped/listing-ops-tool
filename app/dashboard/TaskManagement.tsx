...
function ReasonForPendingModal({ 
  ...
  // FIX: Increased z-index to z-[100] to appear above task detail modal
  return (
    <div 
...
export default function TaskManagement({ theme, currentUserEmail, currentUserName = '' }: TaskManagementProps) {
  ...
  return (
    <div className="flex h-full flex-col">
      ...
      {/* ─── TAB NAVIGATION ────────────────────────────────────────────────── */}
      <div className={`border-b ${isDark ? 'border-slate-700/50' : 'border-gray-200'} flex-shrink-0`}>
        <div className="flex p-2 sm:p-3 gap-2">
          <button
      ...
      {/* Reason for Pending Modal - FIXED: z-[100] to appear above task detail modal */}
